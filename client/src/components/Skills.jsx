...
export default function Skills({skills, stats, proficiencyBonus}) {

    const getModifier = (score) => Math.floor((score - 10) / 2);
    

  return (
    <div className='flex flex-wrap border-2 border-amber-950'>
        {skillList.map((skill) => (
        <div key={skill.key} className='skill-container flex gap-4 items-center p-2'>
